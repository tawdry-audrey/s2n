...
/* Target Functions: s2n_server_ccs_recv s2n_basic_ccs_recv s2n_prf_server_finished
                     s2n_sslv3_server_finished s2n_prf */
...
static const uint8_t TLS_VERSIONS[] = {S2N_TLS10, S2N_TLS11, S2N_TLS12, S2N_SSLv3};
...
int LLVMFuzzerTestOneInput(const uint8_t *buf, size_t len)
{
    ...
    if (len >= 2) {
        ...
        /*if (client_conn->secure.cipher_suite->prf_alg == NULL) {
